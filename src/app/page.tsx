...
const projects = {
    trending: [
        { id: 1, name: "TaskFlow Pro", desc: "AI-powered task management", img: "https://via.placeholder.com/300x170/8b5cf6/ffffff?text=TaskFlow", tags: ["React", "AI"], views: "12.5k" },
        { id: 2, name: "CodeSnap", desc: "Beautiful code screenshots", img: "https://via.placeholder.com/300x170/06b6d4/ffffff?text=CodeSnap", tags: ["Next.js", "TS"], views: "9.8k" },
    ...
    productivity: [
        { id: 5, name: "FocusTimer", desc: "Pomodoro with analytics", img: "https://via.placeholder.com/300x170/10b981/ffffff?text=FocusTimer", tags: ["React", "Charts"], views: "6.8k" },
    ...
    return (
        <>
            ...
            <nav className="nav py-4 px-6">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <a href="/builder" className="btn-primary !py-2 !px-5 text-sm">Start Building</a>
                    </div>
                </div>
            </nav>
            ...
            <main>
                ...
                <section className="min-h-screen flex items-center justify-center relative px-6 pt-20">
                    ...
                    <div className="max-w-5xl text-center z-10">
                        ...
                        <div className="flex gap-4 justify-center flex-wrap">
                            <a href="#showcase" className="btn-primary text-lg">
                                Explore Projects
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                </svg>
                            </a>
                            <a href="#about" className="btn-secondary text-lg">Learn More</a>
                        </div>
                    </div>
                ...
                <section id="showcase" className="section py-24 px-6">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="mb-16">
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="text-2xl font-bold font-heading">🔥 Trending</h3>
                                <a href="#" className="text-primary hover:text-accent transition-colors">View All →</a>
                            </div>
                                        ...
                                        <div key={project.id} className="project-tile">
                                            ...
                                            <div className="p-4">
                                                ...
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span className="text-white/40 text-sm">{project.views} views</span>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="text-2xl font-bold font-heading">⚡ Productivity</h3>
                                <a href="#" className="text-primary hover:text-accent transition-colors">View All →</a>
                            </div>
                            <div className="carousel-wrapper">
                                <div className="project-carousel">
                ...
                {/* About Section */}
                <section id="about" className="section py-24 px-6">
                ...
                {/* Model Section */}
                <section id="model" className="section py-24 px-6">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="model-card glass p-8">
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="grid grid-cols-3 gap-8 text-center">
                            <div>
                                ...
                                <div className="text-white/40 mt-2">Possibilities</div>
                            </div>
                            <div>
                                <div className="stat-value">1</div>
                                <div className="text-white/40 mt-2">Community</div>
                            </div>
                            <div>
                                <div className="stat-value">0</div>
                                <div className="text-white/40 mt-2">Limits</div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="section py-16 px-6">
                    <div className="max-w-6xl mx-auto text-center">
                        ...
                        <p className="text-white/40 mb-8">No-code, low-code, and AI-powered tools</p>
                ...
                <section className="section py-24 px-6">
                    <div className="max-w-4xl mx-auto">
                        <div className="glass p-12 md:p-16 text-center">
                            ...
                            <div className="flex gap-4 justify-center flex-wrap">
                                <a href="/builder" className="btn-primary text-lg">
                                    Start Building
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
